        ...
        <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4">
          ...
          >
            ...
            <motion.p
              ...
              className="text-accent text-lg md:text-xl mb-6 tracking-widest uppercase"
            >
              Hello, I'm
            </motion.p>
            ...
            >
              <motion.a
                ...
                download
                className="group relative inline-flex items-center justify-center px-8 py-4 overflow-hidden rounded-full"
              ...
              >
                ...
                <span className="relative flex items-center gap-2 text-accent font-medium">
          ...
          {/* Scroll indicator - hidden on mobile since View Work serves same purpose */}
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
